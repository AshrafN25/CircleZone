...
const Sidebar = ({ activeSection, onChatOpen }) => {
  ...
  return (
    <aside className="hidden lg:block sticky top-20 h-[calc(100vh-6rem)] w-64">
      <div className="p-4 space-y-2 h-full flex flex-col">
        <h3 className="text-body-sm font-semibold text-on-surface-variant dark:text-gray-400 uppercase tracking-wide px-3 mb-4">
          Daftar Materi
        </h3>
        ...
        {sections.map((section) => (
          <button
            ...
            className={clsx(
              'w-full flex items-center gap-3 px-3 py-2 rounded-lg text-body-md transition-all',
        ...
        <div className="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
          <button
            onClick={onChatOpen}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-tertiary text-on-tertiary font-semibold hover:bg-tertiary-variant transition-colors"
          >
