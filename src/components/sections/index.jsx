...
import { hitungPanjangBusur, hitungLuasJuring, hitungGarisSinggung } from '../../utils/circleFormulas';
...
export const SudutPusatKeliling = () => {
  ...
  return (
    <section id="sudut-pusat-keliling" className="py-20 bg-background dark:bg-gray-950 overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-full">
...
export const PanjangBusur = () => {
  ...
  return (
    <section id="panjang-busur" className="py-20 bg-surface dark:bg-gray-900 overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-full">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
...
export const LuasJuring = () => {
  ...
  return (
    <section id="luas-juring" className="py-20 bg-background dark:bg-gray-950 overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-full">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
...
export const GarisSinggung = () => {
  ...
  return (
    <section id="garis-singgung" className="py-20 bg-surface dark:bg-gray-900 overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-full">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
